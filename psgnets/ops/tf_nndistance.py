...
def nn_distance(xyz1,xyz2):
    '''
        ...
        input: xyz1: (batch_size,#points_1,D)  the first point cloud
        input: xyz2: (batch_size,#points_2,D)  the second point cloud
    ...
    if xyz1.shape[-1] == 3:
        ...
        return nn_distance_2_module.nn_distance2(xyz1,xyz2)
    elif xyz1.shape[-1] == 12:
        return nn_distance_4_module.nn_distance4(xyz1,xyz2)
...
def _nn_distance2_grad(op,grad_dist1,grad_idx1,grad_dist2,grad_idx2):
    xyz1=op.inputs[0]
    xyz2=op.inputs[1]
    idx1=op.outputs[1]
    idx2=op.outputs[3]
    return nn_distance_2_module.nn_distance2_grad(xyz1,xyz2,grad_dist1,idx1,grad_dist2,idx2)

@ops.RegisterGradient('NnDistance4')
def _nn_distance4_grad(op,grad_dist1,grad_idx1,grad_dist2,grad_idx2):
    xyz1=op.inputs[0]
    xyz2=op.inputs[1]
    idx1=op.outputs[1]
    idx2=op.outputs[3]
    return nn_distance_4_module.nn_distance4_grad(xyz1,xyz2,grad_dist1,idx1,grad_dist2,idx2)
