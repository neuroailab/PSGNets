    ...
    'model_params': {
        ...
        'graph_levels': [
            ...
            (models.levels.P2GeoLevel, {
                ...
                # 'vae_attrs': ['vector'], # 118-dimensional input
                'vae_attrs': OrderedDict((
                    # ('vector', [ [0,83],[85,88],[94,97],[103,104],[106,110] ]), # without edge attrs
                    # ('vector', [ [0,88],[88,91],[93,96],[102,105],[111,112],[114,118] ]), # with edge attrs
                    # ('vector', [ [0,40], [40,64], [-4,-1] ]),
                    ('vector', [ [0,40], [40,43], [-4,-1] ]),
                    # ('vector', [ [0,40], [40,54], [-4,-1] ]),
                )),
        ...
        'to_decode': None,
        'train_targets': [IMAGES, OBJECTS, PMAT, VALID],
